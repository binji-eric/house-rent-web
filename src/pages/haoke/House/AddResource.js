          ...
          <Card bordered={false} title="房源信息">
            ...
            <FormItem {...formItemLayout} label="楼栋">
              <InputGroup compact>
                ...
                })(<Input style={{ width: "30%" }} addonAfter="栋" />)}
                {getFieldDecorator("buildingUnit", {
                  rules: [{ required: true, message: "此项为必填项" }]
                })(<Input style={{ width: "30%" }} addonAfter="单元" />)}
                {getFieldDecorator("buildingFloorNum", {
                  rules: [{ required: true, message: "此项为必填项" }]
                })(<Input style={{ width: "30%" }} addonAfter="门牌号" />)}
              </InputGroup>
            </FormItem>
            <FormItem {...formItemLayout} label="租金">
              <InputGroup compact>
                {getFieldDecorator("rent", {
                  rules: [{ required: true, message: "此项为必填项" }]
                })(<Input style={{ width: "50%" }} addonAfter="元/月" />)}
              </InputGroup>
            </FormItem>
            ...
            <FormItem {...formItemLayout} label="户型">
              <InputGroup compact>
                {getFieldDecorator("houseType_1", {
                  rules: [{ required: true, message: "此项为必填项" }]
                })(<Input style={{ width: "18%" }} addonAfter="室" />)}
                {getFieldDecorator("houseType_2", {
                  rules: [{ required: true, message: "此项为必填项" }]
                })(
                  <Input
            ...
            <FormItem {...formItemLayout} label="手机号">
              <InputGroup compact>
                {getFieldDecorator("mobile", {
                  rules: [{ required: true, max: 11, message: "此项为必填项" }]
